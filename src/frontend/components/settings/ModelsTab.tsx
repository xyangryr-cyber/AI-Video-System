...
export function ModelsTab(): ReactElement {
  ...
  return (
    <div data-testid="models-tab" className="bg-white rounded-2xl border-2 border-slate-200 overflow-hidden flex flex-col">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
          <div className="col-span-2 sm:col-span-1">
            ...
            <div className="flex justify-between text-[11px] text-slate-400 mt-2">
              <span>0.0 (更稳定)</span>
              <span className="text-slate-600 font-medium bg-slate-100 px-2 py-0.5 rounded">当前: {temperature.toFixed(1)}</span>
              <span>1.0 (更有创意)</span>
            </div>
          </div>
          <div className="col-span-2 sm:col-span-1">
          ...
          <div className="col-span-2 sm:col-span-1">
            ...
            >
              ...
              <option value="pool" disabled>多线程池 (V1.5+ 支持)</option>
            </select>
          </div>
        </div>
